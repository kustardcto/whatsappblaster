            ...
            <div class="row g-4 text-center text-md-start">
                ...
                <div class="col-lg-2 col-md-4 mx-auto">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="#whatsapp-features" style="color: var(--footer-text); text-decoration: none; transition: all 0.3s; display: block;" onmouseover="this.style.color='var(--primary-color)'" onmouseout="this.style.color='var(--footer-text)'">WhatsApp Features</a></li>
